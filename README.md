...
``` The database was created, and subsequently tables were created for employees, with details about them, properties, details about the properties, and clients.``` 
...
``` The 'sex' column was added to the 'details_employees' table and was subsequently renamed to 'customers'.```
...
```Data has been inserted into all the created tables. ```
